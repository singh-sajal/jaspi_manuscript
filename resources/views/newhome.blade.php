...
<body>
    ...
    <div class="main-content">
            ...
            <div class="text-center text-md-start mb-5 mb-md-0 border-end px-4">
                ...
                <div class="mt-4">
                    <form class="login-form p-0" id="roleLoginForm" method="POST" novalidate>
                            ...
                            <div class="input-group">
                                ...
                                <div class="position-relative auth-pass-inputgroup w-100">
                                    <input type="password" class="form-control password-input passbox pe-5"
                                        placeholder="Your password" required name="password" id="password-input">
                                    <button
                        ...
                        <button type="submit" class="btn btn-primary w-100" id="loginBtn" disabled>Login</button>
                    </form>
                </div>
        ...
        <!-- JS to dynamically set form action and enable login -->
