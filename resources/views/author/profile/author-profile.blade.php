    ...
    <div class="card">
        ...
        <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center card-body border-bottom mb-3">
                        <div class="avatar avatar-xxl border-primary rounded border p-1">
                            <img src="{{ asset($author->avatar ?? 'admin/assets/images/avatar/1.png') }}" class="img-fluid"
                                alt="Img">
                        </div>
                        <div class="ms-3">
                            <h6 class="fw-bold mb-0">{{ $author->name ?? '' }}</h6>
                            <p class="fw-medium mb-1">{{ $author->username ?? '' }}</p>
                            <button class="btn actionHandler btn-dark btn-sm" data-handler="updateAvatar"
                                data-url="{{ route('author.avatar.update') }}">Change Avatar</button>
                        </div>
                    </div>
                    ...
                    <div class="card-body border-bottom mb-3">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="mb-0 me-1">{{ $author->email ?? '' }}</p>
                            <i
                                class="{{ $author->is_email_verified ? 'ri-verified-badge-fill  text-success ' : 'ri-close-circle-fill  text-danger ' }}"></i>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <i
                                class="{{ $author->is_phone_verified ? 'ri-verified-badge-fill  text-success ' : 'ri-close-circle-fill  text-danger ' }}"></i>
                        </div>
                    ...
                    <div class="card-body border-bottom mb-3">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="mb-0">{{ $author->gender ?? '---' }}</p>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="ti ti-calendar"></i>
                            <span class="fw-bold mx-2">Date of Birth</span>
                            <p class="mb-0">{{ $author->dob ?? '---' }}</p>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="ti ti-calendar"></i>
                            <span class="fw-bold mx-2">Joined On</span>
                            <p class="mb-0">{{ $author->created_at->format('F jS, Y') }}</p>
                        </div>
            ...
            <div class="col-md-8 col-12">
                <div class="border">
                    <form action="{{ route('author.profile.update', ['uuid' => $author->uuid]) }}" novalidate
                        method="post">
                        <div class="card-body">
                            @include('author.profile.form')
                        </div>
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <p class="flex-grow-1 mb-0">Want to change your password ? <a href="#"
                                    class="actionHandler" data-url="{{ route('author.password.update') }}"
