...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>ManuScript Author- @yield('title')</title>
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('short_logo.png') }}" />
...
<body data-typography="poppins" data-theme-version="light" data-layout="horizontal" data-header-position="fixed"
    data-sidebar-position="fixed" data-nav-headerbg="black">
    <!--**********************************
        Main wrapper start
    ***********************************-->
    <div id="main-wrapper">
