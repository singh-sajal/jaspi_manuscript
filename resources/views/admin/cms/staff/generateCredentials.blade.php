<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Generate/Update Password</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            </button>
        </div>

        <form action="{{ route('admin.staff.generateCredentials', ['uuid' => $staff->uuid]) }}" novalidate id="CreateForm"
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="email" class="form-control bg-light" readonly name="email" id="email"
                            value="{{ $staff->email ?? '' }}" placeholder="Login email" required>
                    </div>
